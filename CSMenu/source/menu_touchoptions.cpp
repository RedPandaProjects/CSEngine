...
static void UI_TouchOptions_GetProfileList( void )
{
	...
	strncpy_s( uiTouchOptions.profileDesc[i], "Presets:", CS_SIZE );
	...
	strncpy_s( uiTouchOptions.profileDesc[i], "Profiles:", CS_SIZE );
	uiTouchOptions.profileDescPtr[i] = uiTouchOptions.profileDesc[i];
	i++;

	strncpy_s( uiTouchOptions.profileDesc[i], "default", CS_SIZE );
	uiTouchOptions.profileDescPtr[i] = uiTouchOptions.profileDesc[i];
...
static void UI_TouchOptions_Callback( void *self, int event )
{
	...
	case ID_RESET:
		...
		strcpy_s( uiTouchOptions.dialogText, "Reset all buttons?" );
	...
	case ID_DELETE:
		...
		uiTouchOptions.no.generic.flags &= ~QMF_HIDDEN;
		uiTouchOptions.yes.generic.flags &= ~QMF_HIDDEN;
		strcpy_s( uiTouchOptions.dialogText, "Delete selected profile?" );
